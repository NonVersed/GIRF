...
# TODO: Test the functions written here with example k-space trajectories.
...
# Args:
    # 'kspace': array of coordinates in kspace; [x/y/z, m1, ..., mD]
    # 'fov': field-of-view along x/y/z; 1D array of length 3 [x/y/z] in mm
    # 'gamma': gyromagnetic ratio; scalar in MHz/T
# Returns:
    # array of moments along each axis; [x/y/z, m1, ..., mD]
...
# Args:
    # 'moment': array of moments along each axis; [x/y/z, m1, ..., mD]; [uT/mm]-us
    # 'fov': field-of-view along x/y/z; 1D array of length 3 [x/y/z] in mm
    # 'gamma': gyromagnetic ratio; scalar in MHz/T
# Returns:
    # array of k-space coordinates; [x/y/z, m1, ..., mD]
